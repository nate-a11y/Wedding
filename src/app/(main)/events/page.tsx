  ...
  return (
    <div className="section-padding bg-cream">
      <div className="container-wedding">
          ...
          {events.map((event, index) => (
            ...
            >
              <div className="flex flex-col md:flex-row">
                {/* Left accent */}
                <div className="bg-gradient-to-b from-olive-500 to-olive-600 p-6 md:w-48 flex flex-col items-center justify-center text-white">
                ...
                <div className="p-6 md:p-8 flex-1">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <div className="flex items-start gap-2 text-olive-600">
                    ...
                    <div>
                      <p className="text-olive-700 mb-3">{event.description}</p>
                      {event.dressCode && (
        ...
        >
          <div className="bg-olive-100 rounded-lg p-6 max-w-2xl mx-auto">
            <p className="text-olive-700">
              <strong>Note:</strong> Full event details including times and addresses will be
