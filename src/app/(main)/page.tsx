    ...
    <>
        ...
        <div className="container-wedding">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-elegant p-8 text-center">
              ...
              <h3 className="font-heading text-xl text-charcoal mb-2">When</h3>
              <p className="text-olive-600 font-medium">October 31, 2027</p>
              <p className="text-olive-500 text-sm">Time TBA</p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-elegant p-8 text-center">
              ...
              <h3 className="font-heading text-xl text-charcoal mb-2">Where</h3>
              <p className="text-olive-600 font-medium">Location TBA</p>
              <p className="text-olive-500 text-sm">Stay tuned!</p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-elegant p-8 text-center">
              ...
              <h3 className="font-heading text-xl text-charcoal mb-2">RSVP</h3>
              <p className="text-olive-600 font-medium">Coming Soon</p>
              <p className="text-olive-500 text-sm">Check back later</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-white">
        <div className="container-wedding text-center max-w-2xl mx-auto">
          ...
          <div className="gold-line mx-auto mb-8" />
          <div className="bg-olive-50 rounded-lg p-8">
            <div className="w-24 h-24 mx-auto mb-4 rounded-full bg-olive-200 flex items-center justify-center">
              <span className="text-4xl">🐕</span>
            </div>
            <h3 className="font-heading text-2xl text-charcoal mb-2">Honey</h3>
            <p className="text-olive-600 uppercase tracking-wider text-sm mb-4">Flower Girl</p>
